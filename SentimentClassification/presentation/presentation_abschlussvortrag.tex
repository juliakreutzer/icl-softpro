...
\frame{
	...
	\begin{center}
	\includegraphics[scale=0.25]{Klassenarchitektur.eps} 
	\end{center}
}
...
\frame{
	...
	\item Angabe der Parameter (top k Features, Epochen, Kategorien)\\
{\scriptsize hadoop jar HadoopTrainScalable.jar PathIn PathOut 5 1000 divt \grqq books;electronics;dvd;kitchen \grqq}
	\\[0.5cm]
...
\frame{
	...
	{\large Wie gut klassifiziert unser regularisierter Multi Task Perceptron...}
	\begin{itemize}
